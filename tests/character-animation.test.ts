...
const makeRig = (walkOnly = false) => {
  ...
  const controller = new CharacterAnimationController(root, walkOnly ? [walk] : [idle, walk], { clips: { idle: /idle/i, walk: /walk/i } });
...
console.log("Character animation tests passed: initialization, blending, reversals, loops, fallback, independence.");
